const API_KEY = 'e31ebff5b65ca0696cbff1adcd49393f'; // Replace with your actual API key
...
export const fetchWeather = async (cityId) => {
    const apiKey = 'e31ebff5b65ca0696cbff1adcd49393f'; // Replace with your actual API key
